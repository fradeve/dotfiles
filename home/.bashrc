...
## latex / vim
    alias sutlmgr='sudo /usr/local/texlive/2012/bin/i386-linux/tlmgr'
...
## alias mutt / IM
    ...
    alias dati='gpg -d Dropbox/documenti/dati.csv.gpg | grep '
    alias oblique='sh /opt/oblique'
    alias music='sh /home/fradeve/.bin/music'

## gtd
    alias t='cat /home/fradeve/Dropbox/apps/todo/remember && todo.sh -d /home/fradeve/.todo.cfg'
